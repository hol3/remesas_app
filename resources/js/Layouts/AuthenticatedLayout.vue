...
<template>
    <div>
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white dark:bg-slate-800 border-b border-gray-100 dark:border-gray-500">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('mensajeros.index')" :active="route().current('mensajeros.index')">
                                    Mensajeros
                                </NavLink>
            ...
            <!-- Page Heading -->
            <header class="bg-white dark:bg-slate-700 shadow" v-if="$slots.header">
