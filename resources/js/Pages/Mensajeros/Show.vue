                ...
                <div class="overflow-hidden bg-white shadow-sm dark:bg-slate-600 sm:rounded-lg">
                    <div class="grid gap-4 p-6 sm:grid-cols-3">
                        <div class="p-4 bg-gray-400 border border-gray-800 rounded-md dark:bg-slate-700">
                            <h1 class="text-2xl font-bold text-gray-600 dark:text-gray-200">
                                Perfil
                            </h1>
                            <form @submit.prevent="submit">
                                ...
                                <div class="flex mt-4">
                                    <input type="checkbox" class="w-6 h-6 rounded-full shadow" name="tiene_efectivo"
                                        id="tiene_efectivo" v-model="form.tiene_efectivo" :true-value="1"
                                        :false-value="0" />
                                    <InputLabel for="tiene_efectivo"
                                        class="flex flex-col justify-center px-2 text-gray-300"
                                        value="Tiene efectivo?" />
                                </div>
                                <div class="flex justify-end mt-4">
                                    <PrimaryButton :class="{
                                        'opacity-25': form.processing,
                                    }" :disabled="form.processing" type="submit">Guardar</PrimaryButton>
                                </div>
                            </form>
                        </div>
                        <div class="p-4 bg-gray-400 border border-gray-800 rounded-md sm:col-span-2 dark:bg-slate-700">
                            <h1 class="mb-2 text-2xl font-bold text-center text-gray-600 dark:text-gray-200">
                                Resumen
                            </h1>
                            <div class="grid p-4 mb-2 rounded-md sm:grid-cols-3 dark:bg-slate-600">
                                <h2 class="text-xl font-bold sm:col-span-3 dark:text-gray-300">
                                    Entregas
                                </h2>
                                <h5 class="text-lg font-semibold dark:text-gray-300 sm:text-center">
                                    Pendientes: {{ pendientes }}
                                </h5>
                                <h5 class="text-lg font-semibold dark:text-gray-300 sm:text-center">
                                    Por cobrar: ${{ cobroPendiente }}
                                </h5>
                                <h5 class="text-lg font-semibold dark:text-gray-300 sm:text-center">
                                    Comisión de hoy: ${{ cobroHoy }}
                                </h5>
                            </div>
                            <div class="p-4 rounded-md dark:bg-slate-600">
                                <div>
                                    <h2 class="mb-2 text-xl font-bold sm:col-span-3 dark:text-gray-300">
                                        Efectivo
                                    </h2>
                                    <table class="w-full dark:text-gray-300">
                                        ...
                                        <tbody>
                                            <tr v-for="efectivo in props.efectivo" :key="efectivo.id"
                                                ...
                                                <td class="text-right">
                                                    {{
                                                        efectivo.cantidadPorEntregar
                                                    }}
                                                </td>
                                                <td class="text-right">
                                                    {{
                                                        efectivo.cantidadEnCaja
                                                    }}
                                                </td>
                                            </tr>
                                        </tbody>
